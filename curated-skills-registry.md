...
|------|-------------|------------|--------------|------|-----------|----------------------------------------------------------------|
| self-apply | Mandatory safety skill hosting the memory-of-use ledger's schema/counting convention and the confirmed-proposal apply/verify/rollback machinery (deny-listed — never itself an apply target; v2.19 adds the `self-*` reserved-prefix deny + `context/.kit-migrations/**`). | builtin | 2026-07-22 | 1 | mandatory-infrastructure | 082f202fe4ada3f8f17055e8f3872dbc07319a00baa593f8483da7f64d19e8f5 |
