...
|------|-------------|------------|--------------|------|-----------|----------------------------------------------------------------|
| self-apply | One of three required safety skills. It records every change you approve, in order, using a consistent format so entries stay easy to track, and requires you to propose a change, check it, and be able to reverse it before it takes effect. This skill is protected from being changed by any other skill. Starting in v2.19, files whose names start with `self-` are protected the same way, along with the `context/.kit-migrations/` folder. | builtin | 2026-07-22 | 1 | mandatory-infrastructure | 082f202fe4ada3f8f17055e8f3872dbc07319a00baa593f8483da7f64d19e8f5 |
| self-archive | One of three required safety skills. It checks whether a file is safe to move before suggesting you archive something old or replaced, confirms the destination makes sense, and keeps a record of every move so it can always be undone. This skill is protected from being changed by any other skill. Starting in v2.19, `self-upgrade` and the `context/.kit-migrations/` folder get the same protection, as an extra backup. | builtin | 2026-07-22 | 1 | mandatory-infrastructure | 7b12d467dbc1fc73cdd058b0d2bacb06fff7b8f9b07614fa2e478a30edf6d7f9 |
| self-upgrade | One of three required safety skills. It handles moving your setup forward when a newer release of this kit becomes available, and protects itself with a write-then-check-then-replace process so an update can never leave things half-finished. It isn't actively used yet in v2.19, since there's no newer release to move to, but it's installed and ready. This skill is protected from being changed by any other skill. | builtin | 2026-07-22 | 1 | mandatory-infrastructure | a4abd71af9dafe8a267af758c86593a1260426a5387f2825f75512559fdf3e11 |
...
| name | description | source_url | vetting_date | tier | goal_tags | sha256 |
|------|-------------|------------|--------------|------|-----------|----------------------------------------------------------------|
| anti-ai-slop | Smooths out text that reads like it was written by AI — flattening repetitive sentence patterns and removing hedging language you didn't ask for. Turned on only when you choose it, and it keeps your own writing voice instead of forcing everything into one fixed style. | builtin | 2026-07-19 | 1 | study,research,writing,project-management,creative,business-admin,personal-assistant | 92c56b918b6c52653d7e724f68fb1b52bbc63d8a4301a4c7d0a7c93ae682487d |
